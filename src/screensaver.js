var screensaver = (function(){
	...
	function init(){
		...
		var movingParts = [
			...
			'toaster t4 p27','toaster t4 p10','toaster t4 p25','toaster t4 p29',
			// wave 2 of (delayed) objects
			'toaster t5 p15','toaster t5 p18','toaster t5 p22',
			// wave 3 of (delayed) objects
			'toaster t6 p6','toaster t6 p11','toaster t6 p15','toaster t6 p19','toaster t6 p23',
			// wave 5 of (delayed) objects
			'toast tst4 p10','toast tst4 p23','toast tst4 p15','toaster t7 p7','toaster t7 p12','toaster t7 p16','toaster t7 p20','toaster t7 p24',
			// wave 6 of (delayed) objects
			'toaster t8 p8','toaster t8 p13','toaster t8 p17','toaster t8 p25',
			// wave 7 of (delayed) objects
			'toaster t9 p14','toaster t9 p18','toaster t9 p21','toaster t9 p26'
		];
